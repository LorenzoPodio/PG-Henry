...
const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/pgexcursiones`, {
...
const { Excursion , User, Product, Order, Order_detail, exc_prod } = sequelize.models;
