...
const buy = [{name:"Navegacion calafate", price: "12500", quantity:"2"  }, {name:"Nueva excursion", price: "1500", quantity:"5"  }]
...
return (
    <div className={style.orderReviewContainer}>
      ...
      <h1 className="grid place-content-center mt-0 mb-0 font-bold text-xl text-neutral-700">DETALLE DE COMPRA</h1>
