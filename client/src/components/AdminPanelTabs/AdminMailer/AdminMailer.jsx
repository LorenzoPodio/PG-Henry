  ...
  return (
    <div className="md:flex items-start justify-center py-20 px-2">
      <div className="md:w-3/5 lg:ml-8 md:ml-6 md:mt-0 mt-6">
        ...
        <div className="py-2 px-2 border-r border-gray-200 flex items-center justify-around w-1/3">
          ...
          <div className="py-2 px-4 border-r  border-l border-gray-200 flex items-center justify-around w-1/3">
