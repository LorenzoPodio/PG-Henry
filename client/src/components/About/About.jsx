...
export const About = () => {
  return (
    <div style={{ backgroundColor: '#D8D2CB' }}>
      ...
      <div style={{ backgroundColor: '#EEEEEE' }} className="w-full px-10 pt-10">
            ...
            <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
              <div className="rounded-md hover:shadow-black overflow-hidden shadow-md shadow-gray-400  bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <div>
                      <SocialIcon className='rounded-full hover:shadow-md hover:shadow-black' url="https://www.linkedin.com/in/damian-yerien/" />
                    </div>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <div>
                      <SocialIcon className='rounded-full hover:shadow-md hover:shadow-black' url="https://github.com/DamianYerien" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
              <div className="rounded-md hover:shadow-black overflow-hidden shadow-md shadow-gray-400  bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <div>
                      <SocialIcon className='rounded-full hover:shadow-md hover:shadow-black' url="https://www.linkedin.com/in/manuel-crespo-682ab8212/" />
                    </div>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <div>
                      <SocialIcon className='rounded-full hover:shadow-md hover:shadow-black' url="https://github.com/Kiron184" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
              <div className="rounded-md hover:shadow-black overflow-hidden shadow-md shadow-gray-400  bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <div>
                      <SocialIcon className='rounded-full hover:shadow-md hover:shadow-black' url="https://www.linkedin.com/in/luciano-pennacchioni/" />
                    </div>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <div>
                      <SocialIcon className='rounded-full hover:shadow-md hover:shadow-black' url="https://github.com/lucianop3196" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
              <div className="rounded-md hover:shadow-black overflow-hidden shadow-md shadow-gray-400  bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <div>
                      <SocialIcon className='rounded-full hover:shadow-md hover:shadow-black' url="https://www.linkedin.com/in/lautarocoello/" />
                    </div>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <div>
                      <SocialIcon className='rounded-full hover:shadow-md hover:shadow-black' url="https://github.com/lautarocoello" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
              <div className="rounded-md hover:shadow-black overflow-hidden shadow-md shadow-gray-400  bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <div>
                      <SocialIcon className='rounded-full hover:shadow-md hover:shadow-black' url="https://www.linkedin.com/in/nicolas-abratte/" />
                    </div>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <div>
                      <SocialIcon className='rounded-full hover:shadow-md hover:shadow-black' url="https://github.com/nabratte" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
              <div className="rounded-md hover:shadow-black overflow-hidden shadow-md shadow-gray-400  bg-white">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    <div>
                      <SocialIcon className='rounded-full hover:shadow-md hover:shadow-black' url="https://www.linkedin.com/in/gregoconst/" />
                    </div>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <div>
                      <SocialIcon className='rounded-full hover:shadow-md hover:shadow-black' url="https://github.com/gregoconst" />
                    </div>
                  </div>
                </div>
              </div>
